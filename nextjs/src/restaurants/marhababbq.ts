...
export const marhabaBBQConfig: RestaurantConfig = {
  ...
  logo: "https://res.cloudinary.com/dvyhnxnpq/image/upload/v1784516309/logo_bfbsgk.webp",
  ...
  faqs: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "We accept Cash on Delivery and supported online payment methods.",
      },
    ],
  },
  ...
  heroSlides: [
    {
      id: "slide-1",
      imageUrl:
        "https://res.cloudinary.com/dvyhnxnpq/image/upload/v1784696551/marahaba-bbq-restaurant_lqizti.webp",
    },
    {
      id: "slide-2",
      imageUrl:
        "https://res.cloudinary.com/dvyhnxnpq/image/upload/v1784697596/family-deals-marahaba-bbq-restaurant_thztdo.webp",
    },
    {
      id: "slide-3",
      imageUrl:
        "https://res.cloudinary.com/dvyhnxnpq/image/upload/v1784697595/bar-b-q-deals-marahaba-bbq-restaurant_bwfsgq.webp",
    },
  ],
  businessType: "restaurant",
  paymentOptions: ["cod", "card", "wallet"],
  copy: {
    featuredSectionTitle: "Signature Best Sellers",
    addToCartLabel: "Add to Order",
    itemNoteLabel: "Serving Note",
  },
};
