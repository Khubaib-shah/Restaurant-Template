...
export const marhababbqItems = [
  { id: "marhaba-item-1", categoryId: "cat-platter", name: "Crispy Club Sandwich", description: "3 layers of chicken, iceberg, tomatoes, mayo & secret sauce.", imageUrl: "https://res.cloudinary.com/dvyhnxnpq/image/upload/v1784516621/clubsandwich_rkgbxq.webp", basePrice: 430, isAvailable: false, isFeatured: true },
  { id: "marhaba-item-2", categoryId: "cat-chicken-karahi", name: "Chicken Karahi (Half)", description: "Tender chicken cooked in spiced tomato masala.", imageUrl: "", basePrice: 950, isAvailable: true, isFeatured: true },
  { id: "marhaba-item-3", categoryId: "cat-chicken-karahi", name: "Chicken Karahi (Full)", description: "Full portion of our signature chicken karahi.", imageUrl: "", basePrice: 1750, isAvailable: true },
  { id: "marhaba-item-4", categoryId: "cat-mutton-karahi", name: "Mutton Karahi (Half)", description: "Tender mutton slow-cooked in rich spices.", imageUrl: "", basePrice: 1650, isAvailable: true, },
  { id: "marhaba-item-5", categoryId: "cat-mutton-karahi", name: "Mutton Karahi (Full)", description: "Full portion of slow-cooked mutton karahi.", imageUrl: "", basePrice: 3100, isAvailable: true },
  { id: "marhaba-item-6", categoryId: "cat-special-handi", name: "Special Handi", description: "Slow-cooked handi with aromatic spices.", imageUrl: "", basePrice: 1200, isAvailable: true, },
  { id: "marhaba-item-7", categoryId: "cat-grill-chargha", name: "Grill Chargha (Half)", description: "Charcoal grilled whole chargha marinated overnight.", imageUrl: "", basePrice: 1100, isAvailable: true, },
  { id: "marhaba-item-8", categoryId: "cat-grill-chargha", name: "Grill Chargha (Full)", description: "Full charcoal grilled chargha.", imageUrl: "", basePrice: 2000, isAvailable: true },
  { id: "marhaba-item-9", categoryId: "cat-singature-bbq", name: "Namkeen Tikka", description: "Juicy chicken tikka with a salty charcoal finish.", imageUrl: "", basePrice: 650, isAvailable: true, },
  { id: "marhaba-item-10", categoryId: "cat-singature-bbq", name: "Malai Boti", description: "Creamy, tender boti grilled over charcoal.", imageUrl: "", basePrice: 700, isAvailable: true },
  { id: "marhaba-item-11", categoryId: "cat-singature-bbq", name: "Behari Boti", description: "Traditional Behari-style boti, marinated and grilled.", imageUrl: "", basePrice: 680, isAvailable: true },
  { id: "marhaba-item-12", categoryId: "cat-chapli-kabab", name: "Chapli Kabab (2 pcs)", description: "Peshawari-style chapli kabab with fresh herbs and spices.", imageUrl: "", basePrice: 380, isAvailable: true, },
  { id: "marhaba-item-13", categoryId: "cat-chapli-kabab", name: "Chapli Kabab (4 pcs)", description: "Generous portion of Peshawari chapli kabab.", imageUrl: "", basePrice: 720, isAvailable: true },
  { id: "marhaba-item-14", categoryId: "cat-club-sandwich", name: "Club Sandwich", description: "Layered club sandwich with fresh vegetables and sauce.", imageUrl: "", basePrice: 430, isAvailable: true },
  { id: "marhaba-item-15", categoryId: "cat-special-roll", name: "Chicken Roll", description: "Crispy roll stuffed with spiced chicken and chutney.", imageUrl: "", basePrice: 280, isAvailable: true, isFeatured: true },
  { id: "marhaba-item-16", categoryId: "cat-afghani-boti", name: "Afghani Pulao", description: "Fragrant rice cooked with meat in Afghani style.", imageUrl: "", basePrice: 550, isAvailable: true, isFeatured: true },
  { id: "marhaba-item-17", categoryId: "cat-extra", name: "Raita", description: "Fresh yoghurt raita to accompany your meal.", imageUrl: "", basePrice: 80, isAvailable: true },
  { id: "marhaba-item-18", categoryId: "cat-extra", name: "Salad", description: "Fresh mixed salad.", imageUrl: "", basePrice: 80, isAvailable: true },
  { id: "marhaba-item-19", categoryId: "cat-extra", name: "Kheer", description: "Traditional rice kheer dessert.", imageUrl: "", basePrice: 120, isAvailable: true },
];
