...
const logoSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  ...
  <text x="50" y="54" font-family="'Inter', 'Times New Roman', serif" font-size="10" font-weight="900" fill="#FFFFFF" text-anchor="middle" letter-spacing="1">GHALIB</text>
</svg>`;
...
export const restaurantConfig: RestaurantConfig = {
  ...
  contact: {
    ...
    address: 'Rooftop @ Habitt Building On Main, Tipu Sultan Rd, off Shahrah-e-Faisal Road, Karachi'
  },
  social: {
  ...
  seoText: 'Check out the amazing food variety of Ghalib Restaurant - Karachi. We strive to bring the best experience of online ordering and delivery to our customers in Karachi. If you are looking for online DEALS deals with home delivery across Karachi then look no further, order now your favorite DEALS from Ghalib Restaurant & enjoy your day.',
  brand: {
    primaryColor: '#1A3C2E',
    accentColor: '#E63946',
    bgImage: 'https://assets.indolj.io/upload/1713772718-background-2.jpg',
    cardStyle: 'default'
  },
  heroSlides: [
    {
    ...
    {
      id: 'slide-2',
      imageUrl: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=1200&auto=format&fit=crop&q=80',
    ...
    {
      id: 'slide-3',
      imageUrl: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=1200&auto=format&fit=crop&q=80',
...
// TODO: MULTI-TENANT — Replace with: await api.getRestaurantConfig(slug)
