    ...
    <div id="search-section-wrapper" className="w-full flex justify-center px-4 mt-1.5 mb-1 lg:mt-5 lg:mb-1.5 select-none shrink-0">
      <div className="relative w-full max-w-[480px] focus-within:max-w-[750px] h-11 lg:h-12 flex items-center transition-all duration-500 ease-out">
        ...
        <input
          ...
          className="w-full h-full bg-background-card pl-11 pr-12 rounded-full border-[1.5px] border-brand-primary focus:border-brand-primary-hover focus:outline-none text-xs lg:text-sm font-medium text-gray-800 placeholder-gray-400 shadow-sm transition-colors"
        />
        ...
        {query && (
          <button
            onClick={handleClear}
            className="absolute right-12 p-1.5 rounded-full hover:bg-gray-100 text-text-secondary hover:text-gray-600 transition-all cursor-pointer"
        ...
        <div className="absolute right-1.5">
          <div className="w-8 h-8 lg:w-9 lg:h-9 rounded-full bg-brand-primary text-text-inverse flex items-center justify-center shadow-sm select-none">
            <ArrowRight size={16} />
          </div>
        </div>
